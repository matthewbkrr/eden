defmodule Eden.Images do
  ...
  # before any full decode. 32 MP (≈5657²) clears any real avatar/photo while bounding a
  # decompression bomb's memory: over the cap, compress_photo degrades to `:keep` (store
  # the original as-is) and square_avatar rejects. Tighter than the thumbnail-worker cap
  # since these run on the request path (#231).
